#!/bin/bash
# AG News OELM-QK-FFN 实验启动脚本
# 用法: ./run_agnews_oelm_qk_ffn.sh [GPU_ID] [LR_INDEX]
#   GPU_ID: GPU编号 (默认0)
#   LR_INDEX: 学习率索引 0=1e-3, 1=3e-3, 2=1e-2 (默认0)
...
# 输出目录
OUTPUT_DIR="$PROJECT_DIR/outputs_phase4/AGNEWS_oelm_qk_ffn_lr${LR_NAME}"
mkdir -p $OUTPUT_DIR
