#!/bin/bash
# =============================================================================
# GPT-03: TinyStories OELM-Random (消融实验)
# =============================================================================
# 实验描述:
#   - 数据集: TinyStories (短篇故事数据集)
#   - 模型: GPT Medium-512 (6层, 8头, 512维)
#   - 方法: 冻结Q/K但使用随机初始化 (消融实验)
#   - 学习率: 1e-3
#
# 目的:
#   - 验证正交初始化的必要性
#   - 对比 OELM-Freeze vs OELM-Random
#
# 历史结果 (参考):
#   - Final PPL: 4.97
#   - 与Baseline差距: +16.4%
...
echo "配置:"
echo "  数据集: $DATASET"
echo "  模型: $MODEL_TYPE (消融 - 随机初始化)"
echo "  学习率: $LR"
echo "  步数: $MAX_STEPS"
echo "  GPU: $GPU_NAME"
echo "  输出: $OUT_DIR"
echo ""
echo "消融目的: 验证正交初始化必要性"
echo "=========================================="
...
echo ""
echo "对比目标: vs GPT-02 (OELM-Freeze) 验证正交初始化效果"
