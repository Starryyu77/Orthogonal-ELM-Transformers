...
**模型架构**: GPT-2 (d_model=512, num_layers=6, num_heads=8)

| 方法 | 总参数量 | 可训练参数量 | 训练时间节省 | 说明 |
|------|----------|--------------|--------------|------|
| **Baseline** | 38.54M (100%) | 38.54M (100%) | - | 全量微调 |
| **OELM-QK** | 38.54M (100%) | 29.21M (75.8%) | ~10% | 冻结 Q/K 投影 |
| **OELM-QK-FFN** | 38.54M (100%) | 25.05M (65.0%) | ~15% | 冻结 Q/K + FFN |

**参数量计算详情**:
- Embedding 层: 13.11M (固定)
- Attention Q/K/V/O: 4 × 2.10M = 8.40M
  - Q/K 冻结: 节省 4.20M 参数
  - V/O 可训练: 4.20M
- FFN Up/Down: 2 × 8.39M = 16.79M
  - FFN 冻结: 节省 16.79M 参数
...
BB|
TX|| 数据集 | 方法 | 准确率 | 训练时间 | 可训练参数 | vs Baseline |
MY||--------|------|--------|----------|------------|-------------|
QP|| **AG News** | Baseline | 92.46% | 2h04m | 38.54M (100%) | - |
VX|| | OELM-QK | 91.86% | 1h54m | 29.21M (75.8%) | -0.60% |
VN|| | **OELM-QK-FFN** | **92.32%** | **1h42m** | **25.05M (65.0%)** | **-0.14%** ⭐ |
KR|| **SST-2** | Baseline | 77.29% | 18m38s | 38.54M (100%) | - |
XN|| | OELM-QK | 78.78% | 16m28s | 29.21M (75.8%) | +1.49% |
QZ|| | **OELM-QK-FFN** | **82.22%** | **10m08s** | **25.05M (65.0%)** | **+4.93%** 🏆 |
BW|| **XNLI** | Baseline | 52.49% | 6h15m | 38.54M (100%) | - |
MJ|| | OELM-QK | 33.33% | 6h18m | 29.21M (75.8%) | -19.16% |
BK|| | **OELM-QK-FFN** | **61.00%** | **5h25m** | **25.05M (65.0%)** | **+8.51%** 🏆 |
ZQ|| **MNLI** | Baseline | 31.82% | 6h22m | 38.54M (100%) | - |
MJ|| | **OELM-QK** | **58.25%** | **6h13m** | **29.21M (75.8%)** | **+26.43%** 🏆 |
BS|| | **OELM-QK-FFN** | **60.35%** | **5h28m** | **25.05M (65.0%)** | **+28.53%** 🏆 |
