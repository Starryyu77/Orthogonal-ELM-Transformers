#!/bin/bash
# XNLI OELM-FFN-only 实验启动脚本
# 用法: ./run_xnli_oelm_ffn_only.sh [GPU_ID] [LR_INDEX]
#   GPU_ID: GPU编号 (默认0)
...
# 输出目录
OUTPUT_DIR="$PROJECT_DIR/outputs_phase4/XNLI_oelm_ffn_only_lr${LR_NAME}"
mkdir -p $OUTPUT_DIR
