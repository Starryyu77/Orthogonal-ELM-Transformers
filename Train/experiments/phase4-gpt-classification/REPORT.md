...
| **MNLI** | 3 | 392,702 | 9,815 | 自然语言推理 (更大验证集) |
...
| **MNLI** | 45.18% | **56.78%** | +11.60% | +25.7% | -4.3% |
| **平均** | - | - | **+8.99%** | **+16.6%** | **-8.7%** |
...
#### MNLI (自然语言推理，3分类，更大验证集)

```
Baseline:  45.18%  |  训练时间: 2h 38m 29s
OELM:      56.78%  |  训练时间: 2h 31m 36s
提升:      +11.60% |  快 6m 53s (4.3%)
```

**分析**：
- **与 XNLI 完全一致的提升幅度**：+11.60%
- 验证集更大（9,815 vs 2,490），结果更可靠
- 训练时间比 XNLI 更快（集群负载较低）
- 证明 OELM 在 NLI 任务上的**稳定性和可重复性**

**详见**: [MNLI 详细实验报告](./REPORT_MNLI.md)
...
1. ✅ ~~**MNLI实验**：更大规模的NLI数据集~~ **已完成**
2. **大模型验证**：GPT-Large, GPT-XL规模
3. **长序列测试**：1024, 2048长度
4. **其他分类任务**：NER、阅读理解等
5. **MNLI mismatched 验证**：跨领域泛化能力评估
...
├── MNLI_baseline/results.json
└── MNLI_oelm_freeze/results.json
```
...
// Baseline
{
  "best_accuracy": 45.175751400916965,
  "final_val_accuracy": 45.175751400916965,
  "final_val_loss": 1.0409905122235077,
  "total_time": "2h 38m 29s"
}

// OELM-Freeze
{
  "best_accuracy": 56.78043810494141,
  "final_val_accuracy": 56.78043810494141,
  "final_val_loss": 0.8986354601790928,
  "total_time": "2h 31m 36s"
}
```
...
*报告更新时间: 2026-02-28 (新增 MNLI 实验结果)*
*实验负责人: tianyu016*
