"""
OELM Fine-tuning from Pretrained Models
...
def load_dataset_for_classification(
    ...
    if dataset_name == "imdb":
        ...
        text_key = "text"
        label_key = "label"
    elif dataset_name == "agnews" or dataset_name == "ag_news":
...
def main():
    parser = argparse.ArgumentParser(description="OELM Fine-tuning")
    ...
    parser.add_argument(
        ...
        type=str,
        default="imdb",
        choices=["imdb", "agnews", "ag_news", "sst2"],
    ...
    print(f"\n{'=' * 60}")
    print("OELM Fine-tuning Configuration")
    print("=" * 60)
